...
// typedef BitOrder BusIOBitOrder; // Removed this line

typedef uint8_t BusIOBitOrder; // Force BusIOBitOrder to be uint8_t
#endif
...
public:
  ...
  Adafruit_SPIDevice(int8_t cspin, uint32_t freq = 1000000,
                     BusIOBitOrder dataOrder = static_cast<BusIOBitOrder>(SPI_BITORDER_MSBFIRST),
